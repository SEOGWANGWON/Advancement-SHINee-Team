	        ...
	        <section>
				...
				<br>
	                <%
						...
						List<Playlist_info_VO> playlists = playlistDAO.getAllPlaylists(id);
	                ...
	                <%
	            		...
	            		%>
			                <div style="display: inline-block; margin: 10px;">
			                	...
			                	%>
					                     <a href="MyPage.jsp?user_id=<%=f.getFollowing_id()%>"><img class="profile" src="<%= f.getProfile_img() %>" style="width: 200px; height: 200px;"></a>
					            <%
			                		}
					            %>
